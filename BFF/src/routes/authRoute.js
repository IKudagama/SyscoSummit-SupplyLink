...
const { JWT_SECRET, JWT_EXPIRATION, COGNITO_REGION, COGNITO_USER_POOL_ID, COGNITO_CLIENT_ID } = require("../config/config");
//const logger = require("../utils/logger"); // A logger utility to log errors/info
